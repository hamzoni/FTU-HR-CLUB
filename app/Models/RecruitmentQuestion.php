 ...
 * @mixin \Eloquent
 */
class RecruitmentQuestion extends Base
{
     ...
     * @var string
     */
    protected $table = 'recruitment_questions';
    ...
    {
        return asset('images/recruitment_question/'.$value);
    }

    public function answers()
    {
        return $this->hasMany(RecruitmentAnswer::class, 'question_id', 'id');
    }
    /*
     * API Presentation
     */
