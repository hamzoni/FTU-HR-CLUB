...
class RepositoryBindServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(
            'App\Repositories\UserInformationRepositoryInterface',
            'App\Repositories\Eloquent\UserInformationRepository'
        );

        $this->app->singleton(
            'App\Repositories\UserAnswerRepositoryInterface',
            'App\Repositories\Eloquent\UserAnswerRepository'
        );

        $this->app->singleton(
            'App\Repositories\UserTestRepositoryInterface',
            'App\Repositories\Eloquent\UserTestRepository'
        );
