<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li @if( $menu=='file') class="active" @endif ><a href="{!! action('Admin\FileController@index') !!}"><i class="fa fa-users"></i> <span>Files</span></a></li>
            <li @if( $menu=='user_information') class="active" @endif ><a href="{!! action('Admin\UserInformationController@index') !!}"><i class="fa fa-users"></i> <span>UserInformations</span></a></li>
            <li @if( $menu=='user_test') class="active" @endif ><a href="{!! action('Admin\UserTestController@index') !!}"><i class="fa fa-users"></i> <span>UserTests</span></a></li>
            <li @if( $menu=='user_answer') class="active" @endif ><a href="{!! action('Admin\UserAnswerController@index') !!}"><i class="fa fa-users"></i> <span>UserAnswers</span></a></li>
            <li @if( $menu=='send-cv-mail') class="active" @endif ><a href="{!! action('Admin\EmailController@index') !!}"><i class="fa fa-users"></i> <span>Gửi email kết quả chấm CV</span></a></li>
            <!-- %%SIDEMENU%% -->
        </ul>
    </section>
</aside>