...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">
                <p class="text-right">
                    <a href="{!! URL::action('Admin\UserController@export') !!}" class="btn btn-danger btn-sm">Export</a>
                    <a href="{!! URL::action('Admin\UserController@exportTests') !!}" class="btn btn-danger btn-sm">Export Test Online</a>
                </p>
            </h3>
