            ...
            <div class="hrc-personality-test-questions-container hide" id="hrc-personality-section-start-start">
                ...
                <div class="finish-test-online hide">
                    @if ($authUser->information)
                        <p>
                            Chúc mừng <b>{{ $authUser->information->fullname }}</b> đã hoàn thành bài thi vòng 1.1: Test Online Ứng viên Tài năng 2017.
                        </p>
                    @else
                        <p>
                            Chúc mừng bạn đã hoàn thành bài thi vòng 1.1: Test Online Ứng viên Tài năng 2017.
                        </p>
                    @endif

                    <p>
                        Kết quả bài thi sẽ được thông báo tới bạn trong <b>tối ngày 17/11/2017</b>.
                    </p>
                ...
                <div class="not-enough-requirement hide">
                    <p>Bạn không đủ điều kiện tham gia vòng 1.1: Test Online Ứng viên Tài năng 2017.</p>
                    <p>Bạn đã không nộp CV tham dự Ứng viên Tài năng 2017 trước 24H ngày 13/11/2017.</p>
                </div>
            </div>
    ...
    var TestOnlineFunc = {
        ...
        finishExam: function () {
            var sendFinishExam = function (city) {
                ...
                request.done(function(data) {
                    bootbox.alert({
                        message: 'Chúc mừng bạn đã hoàn thành bài thi vòng 1.1: Test online Ứng viên Tài năng 2017.',
