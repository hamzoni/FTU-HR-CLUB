...
<head>
    ...
    <title>Kết quả Comment CV</title>
                                            ...
                                            <tr>
                                                <td class="mcnImageContent" valign="top"
                                                    ...
                                                    <img align="center" alt=""
                                                         src="https://gallery.mailchimp.com/50f76b68b70cef19c5c305af2/images/03e032f3-ac17-4d90-b407-4856e6df7f45.png"
                                                         width="564"
                                                    ...
                                                    <div style="text-align: center;">
                                                        <div style="text-align: justify;"><span
                                                                    style="font-size:13px"><span
                                                                        style="color:#20a286"><strong>Chào {{ $cv->name }}
                                                                        ,</strong></span><br>
<br>
Lời đầu tiên, cảm ơn bạn đã tham gia đồng hành cùng Ứng viên Tài năng 2017. Là 1 trong 2000 đăng kí đầu tiên tham gia Ứng viên Tài năng, CV của bạn đã được những chuyên gia nhận xét, đánh giá chi tiết. Sau đây là những comment của chúng tôi cho CV của bạn.<br>
<br>
                                                                @foreach ($commentData as $index=>$group)
<p style="font-size:13px">{{ $index+1 }}. {{ $group['title'] }}</p>
                                                                <ul>
                                                                    @foreach($group['comment'] as $comment)
                                                                        <li style="font-size:13px">{!!  $comment->content  !!}</li>
                                                                        @endforeach
                                                                    @if($group['guide'])
                                                                    <li style="font-size:13px">{!!  nl2br($group['guide'])  !!}</li>
                                                                        @endif
                                                                </ul>
                                                                @endforeach
...
Các bạn có thể xem mẫu CV chuẩn <a href="https://drive.google.com/file/d/1G4-FgI7y60UUB9b2RXnqCXvoE754JvUg/view" target="_blank">tại đây</a>.<br>
<br>
Trải qua 1/4 chặng đường của Ứng viên Tài năng 2017, chúng tôi khát khao được hỗ trợ các bạn sinh viên nhiều hơn nữa. Chúng tôi mong muốn được tìm hiểu thêm  những vấn đề mà các bạn vẫn đang trăn trở, để có thể tổ chức một buổi khác tương tự như Comment CV trong tương lai.<br>
<br>
Bởi vậy, hãy giúp HRC dành ra ít hơn 5 phút để hoàn thành Khảo sát sau. Để thay lời cảm ơn, xin tặng bạn một món quà đến từ HRC: bộ tài liệu "Tuyệt kĩ phỏng vấn" - 1001 tips lưu ý khi tham gia phỏng vấn.<br>
<br>
Ban Tổ chức Ứng viên Tài năng 2017.</span></div>
                                                    </div>
                        ...
                        <td valign="top" id="templateBody"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonBlock" style="min-width:100%;">
                                ...
                                <tr>
                                    <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                                        <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #00A286;">
                                            <tbody>
                                            <tr>
                                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                                    <a class="mcnButton " title="Khảo sát Kĩ năng Tuyển dụng" href="https://docs.google.com/forms/d/e/1FAIpQLSeXmgzhLEn418HTW-bJawvr2GIX1jLEQqgco2sRvG5-n1wzng/viewform" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Khảo sát Kĩ năng Tuyển dụng</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" class="mcnTextContent"
                                                    style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;text-align:center;font-size:12px;">

                                                    Email này được gửi tới {{ $cv->email }}<br>
                                                    Để ngừng nhận tin, vui lòng chọn unsubscribe
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                                                                                    ...
                                                                                                    <table align="left"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td align="center"
                                                                                                                ...
                                                                                                                <a href="https://www.facebook.com/hrc.ungvientainang"
                                                                                                                   target="_blank"><img
                                                                                                            ...
                                                                                                            <td align="left"
                                                                                                                ...
                                                                                                                <a href="https://www.facebook.com/hrc.ungvientainang"
                                                                                                                   target=""
                                                                                                                   style="font-family: Helvetica;font-size: 12px;text-decoration: none;color: #656565;font-weight: bold;">Facebook</a>
                                                                                                            </td>
                                                                                                    ...
                                                                                                    <table align="left"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td align="center"
                                                                                                                ...
                                                                                                                width="24"
                                                                                                                class="mcnFollowIconContent">
                                                                                                                <a href="http://uvtn.hrc.com.vn/"
                                                                                                                   target="_blank"><img
                                                                                                                            src="https://cdn-images.mailchimp.com/icons/social-block-v2/outline-color-link-48.png"
                                                                                                                            style="display:block;"
                                                                                                                            height="24"
                                                                                                                            width="24"
                                                                                                                            class=""></a>
                                                                                                            ...
                                                                                                            <td align="left"
                                                                                                                ...
                                                                                                                <a href="http://uvtn.hrc.com.vn/"
                                                                                                                   target=""
                                                                                                                   style="font-family: Helvetica;font-size: 12px;text-decoration: none;color: #656565;font-weight: bold;">UVTN</a>
                                                                                                            </td>
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" class="mcnTextContent"
                                                    ...
                                                    <a href="https://hrc.com.vn/" target="_blank">Hrc.com.vn</a> -&nbsp;Trang
                                                    tìm việc và hướng nghiệp duy nhất cho sinh viên kinh tế<br>
                                                    Câu lạc bộ Nguồn nhân lực - Đại học Ngoại thương
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
